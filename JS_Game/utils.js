import { playerState } from "./src/state/stateManager.js";
import { healthBar } from "./src/uiComponents/healthbar.js";
...
export async function drawTiles(k, map, layer, tileheight, tilewidth) {
